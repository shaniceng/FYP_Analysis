...
//            R.drawable.ic_awesome_swimming,R.drawable.ic_awesome_strengthtraining,R.drawable.ic_awesome_others};
    ...
    public CustomAdapter(ArrayList<String> dataset, ArrayList<String> timeSet, ArrayList<String> currentTime, ArrayList<String> heartRateAvr){
        mDataSet=dataset;
        mTimeSet=timeSet;
        this.currentTime=currentTime;
       // this.image=image;   ArrayList<Integer> image,
    ...
    public CustomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_lockin,parent, false);
